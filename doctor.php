...
if (isset($_POST["submit"])) {
    ...
    $select = " SELECT * FROM driver_form WHERE email = '$email' && password = '$pass' ";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($pass != $cpass) {
            ...
            $insert = "INSERT INTO driver_form(name, number, email, password,user_type) VALUES('$name','$number','$email','$pass','$user_type')";
